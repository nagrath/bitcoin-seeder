...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "StakeCubeCoin-seeder\n"
...
static const string mainnet_seeds[] = {"95.179.165.19", "209.250.224.166", "108.61.212.198", "78.141.211.79", "95.179.209.111", "" };
static const string testnet_seeds[] = {"" };
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  //if (!fTestNet){
  //  db.Add(CService("xyz.onion", 40000), true);
  //}
  do {
